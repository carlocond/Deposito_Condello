        ...
        while (!esci)
        {
            ...
            switch (scelta)
            {
                    ...
                    while (agg)
                    {
                        ...
                        switch (sceltaAggiunta)
                        {
                            ...
                            case "3":
                                ...
                                break;
                            case "0":
                                Console.WriteLine("Ok, nessuna aggiunta. Allora devi pagare " + bevandaCaffe.Costo() + "€");
                                agg = false;
                                Console.WriteLine("Grazie per aver scelto il nostro Caffè!");
                                break;
                            default:
                ...
                case "2":
                    ...
                    {
                        Console.WriteLine("Vuoi aggiungere qualcosa? (1) Latte (2) Cioccolato (3) Panna (0) Nessuno");
                        sceltaAggiuntaTè = Console.ReadLine();
                        switch (sceltaAggiuntaTè)
                        {
                            ...
                            case "3":
                                ...
                                break;
                            case "0":
                                Console.WriteLine("Ok, nessuna aggiunta. Allora devi pagare " + bevandaTè.Costo() + "€");
                                agg = false;
                                Console.WriteLine("Grazie per aver scelto il nostro Tè!");
                                break;
                            default:
                                Console.WriteLine("Scelta non valida.");
                                continue;
